...
.controller('TodoCtrl', function($scope, $timeout, $ionicModal, Projects, $ionicSideMenuDelegate, $ionicPopup) {
  ...
  // Called to select the given task to delete the task
  $scope.removeTask = function(project, index) {
  ...
  // Create our delete modal
  $ionicModal.fromTemplateUrl('delete-task.html', function(modal) {
